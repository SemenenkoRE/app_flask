...
btnResult.addEventListener('click', function (event) {
    ...
    if (statusRed == true ||
        (dateSale.value == "" && articul.value == "" && weight.value == "")) {
...
// Дата
let dateSale= document.querySelector('[name="date"]')
...
dateSale.addEventListener("click", indicateMistakes);
articul.addEventListener("click", indicateMistakes);
weight.addEventListener("click", indicateMistakes);
